...
function calculate() {
  if(document.getElementById('decrypt').checked) {
    ...
    if(error) {
      ...
      outputBlock.innerHTML = `<span class="outputLabel">Original Text is: </span><span class="answer">'</span><span class="answer">${originalText}</span><span class="answer">'</span>`;
  ...
  if(document.getElementById('encrypt').checked){
    ...
    if(error) {
      ...
      outputBlock.style.display = 'block';
      // inputBlock.style.borderBottom = '3px solid black';
      outputBlock.innerHTML = `<span class="outputLabel">Cipher Text is: </span><span class="answer">'</span></span><span class="answer">${cipherText}</span><span class="answer">'</span>`;
      copyAnswer.innerHTML = `<i class="far fa-copy copyIcon" onclick="copyAnswerText()"></i>`;
      copyAnswer.style.display = 'block';
      programVisualizeBlock.style.display = 'block';
      programOutputBlock.style.display = 'block';
